...
def AncillaBernoulliCircuit(L,T,p,initseed,finalflag = True):
    ...
    #Intial Entropy measure from setup up simulator
...
for i in range(int(sys.argv[3])):
    RealizationEntropy,RealizationMeasure,RealizationMagnetization = AncillaBernoulliCircuit(int(L),T,float(p),initseed[i])
