...
p = sys.argv[2]
T = 2*int(L)**2
initseed = [item for sublist in initseeds for item in sublist]
...
for i in range(int(sys.argv[3])):
    RealizationEntropy,RealizationMeasure,RealizationMagnetization = BernoulliCircuit(int(L),T,float(p),initseed[i])
    TotalRealizationEntropy.append(RealizationEntropy[-1])
    TotalRealizationEntropysquared.append(RealizationEntropy[-1]**2)
...
np.save("L" + str(L) + "P" + str(int(round(float(p)*1000,0))) + "DenseProbBernoulliDataEntropy",TotalRealizationEntropy)
np.save("L" + str(L) + "P" + str(int(round(float(p)*1000,0))) + "DenseProbBernoulliDataEntropysquared",TotalRealizationEntropysquared)
np.save("L" + str(L) + "P" + str(int(round(float(p)*1000,0))) + "DenseProbBernoulliDataMag",TotalRealizationMagnetization)
np.save("L" + str(L) + "P" + str(int(round(float(p)*1000,0))) + "DenseProbBernoulliDataMagsquared",TotalRealizationMagnetizationsquared)
np.save("L" + str(L) + "P" + str(int(round(float(p)*1000,0))) + "DenseProbBernoulliDataMeasurements",measurementarr)
#stop = timer()
#print(stop-start)
